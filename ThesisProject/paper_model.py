...
def model(x):
    ...
    x9 = bn(relu(conv2d_transpose(x8, 64, kernel_size=(3, 3), stride=(2, 2), padding='SAME',
                                  activation_fn=None)))  # None*12*16*64
    # pad_x9 = tf.pad(x9, [[0 ,0], [1, 1], [1, 1], [0, 0]], 'CONSTANT')
    x10 = bn(relu(conv2d_transpose(x9, 32, kernel_size=(3, 3), stride=(2, 2), padding='SAME',
                                   activation_fn=None)))  # None*24*32*32
    ...
    with tf.Session(config=config) as sess:
        ...
        for epoch in range(n_epochs):
            ...
            for iter_train in range(iter_num):
                x_batch_shape = np_data_train[iter_train * batch_size:iter_train * batch_size + batch_size,
                                0:resolution]
                x_batch_load_x = np_data_train[iter_train * batch_size:iter_train * batch_size + batch_size,
                                 resolution:resolution * 2]
                x_batch_load_y = np_data_train[iter_train * batch_size:iter_train * batch_size + batch_size,
                                 resolution * 2:resolution * 3]
                x_batch_boundry_x = np_data_train[iter_train * batch_size:iter_train * batch_size + batch_size,
                                    resolution * 3:resolution * 4]
                x_batch_boundry_y = np_data_train[iter_train * batch_size:iter_train * batch_size + batch_size,
                ...
                y_batch = np_data_train[iter_train * batch_size:iter_train * batch_size + batch_size,
            ...
            for iter_test in range(test_iter_num):
                ...
                x_test_load_x = np_data_test[iter_test * batch_test:iter_test * batch_test + batch_test,
                                resolution:resolution * 2]
                x_test_load_y = np_data_test[iter_test * batch_test:iter_test * batch_test + batch_test,
                                resolution * 2:resolution * 3]
                x_test_boundry_x = np_data_test[iter_test * batch_test:iter_test * batch_test + batch_test,
                                   resolution * 3:resolution * 4]
                x_test_boundry_y = np_data_test[iter_test * batch_test:iter_test * batch_test + batch_test,
                                   resolution * 4:resolution * 5]
                ...
                y_test = np_data_test[iter_test * batch_test:iter_test * batch_test + batch_test,
                         resolution * 5:resolution * 6]
                test_mse, test_mae, test_prediction = sess.run([mse, mae, prediction],
                                                               feed_dict={xs: x_test, ys: y_test})
